...
@section('content')
    <div class="container mt-5">
        <div class="text-center">
            ...
            <p class="lead text-muted" style="font-size: 1.2rem;">Îmi pare rău, dar nu ai permisiunea necesară pentru a accesa această secțiune.</p>
            ...
            <div class="alert alert-warning p-4 my-4" style="border-radius: 10px; background-color: #f4e1d2; color: #9c1c1c;">
                ...
                <p>Contactează administratorul salonului pentru a obține acces la această pagină.</p>
            </div>
